...
def generate_report(filepath, total_lines, total_words,total_chars_no_spaces,
                    most_common_word,most_common_count, word_counts):
    ...
    report.append(f"  Total Characters :   {total_chars_no_spaces}")
    report.append(f'  Most Frequent Word:       "{most_common_word}" ({most_common_count} times)')
    return "\n".join(report)
